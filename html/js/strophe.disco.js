...
Strophe.addConnectionPlugin('disco',
{
    ...
    this._connection = conn;
        ...
        this.addFeature(Strophe.NS.DISCO_ITEMS);
    },
    ...
    statusChanged: function(status, condition) {
        if (status == Strophe.Status.ATTACHED || status == Strophe.Status.CONNECTED)
        {
            try
            {
                ...
                // disco items
                this._connection.addHandler(this._onDiscoItems.bind(this), Strophe.NS.DISCO_ITEMS, 'iq', 'get', null, null);                // Presence subscription
            }
            catch (e)
            {
                Strophe.error(e);
